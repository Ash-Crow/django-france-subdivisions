from francesubdivisions.models import Commune, DataYear, Departement, Epci
from django.test import TestCase
from unittest import mock
import re
from datetime import datetime

from francesubdivisions.services.banatic import (
...
class ZipTestCase(TestCase):
    ...
    def test_match_filenames_in_zip(self) -> None:
        ...
        with mock.patch("francesubdivisions.services.banatic.ZipFile") as MockZipFile:
...
class FirstDayOfQuarterTestCase(TestCase):
    def test_returns_first_day_of_current_quarter(self) -> None:
        with mock.patch(
            "francesubdivisions.services.banatic.datetime"
        ) as mock_datetime:
